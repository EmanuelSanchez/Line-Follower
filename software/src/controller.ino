...
// int32_t  Lcount_enc, Rcount_enc;
// int32_t  Lcount_enc_old, Rcount_enc_old;
...
//     Lcount_enc  = getRot1Steps();
//     Rcount_enc = getRot2Steps();
//
//     // Calculate wheel speeds in mm/s
//     VR = (Rcount_enc - Rcount_enc_old) / counts_to_mm * 1000 * 1000/interruptTiming; // the *1000 is to convert from mm/ms to mm/s
//     VL = (Lcount_enc - Lcount_enc_old)   / counts_to_mm * 1000 * 1000/interruptTiming;
//     Vmean = (VR + VL)/2;        // Mean speed
//     Wenc = VR - VL;             // Angular velocity measured by the encoders in degree/s
//
//     // Update variables
//     Rcount_enc_old = Rcount_enc;
//     Lcount_enc_old = Lcount_enc;
//
